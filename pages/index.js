          ...
          <div class="flex flex-wrap -m-4">
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div class="h-full text-center">
                <img alt="testimonial" class="w-full h-80 mb-8 object-cover object-center rounded-xl inline-block border-2 border-gray-200 bg-gray-100" src="/img/a1.png"/>
                  <p class="leading-relaxed">SPEED is one of the biggest events of its kind in Delhi-NCR region. The event was inaugurated by Mr. Venkatesh Sarvasiddhi, Head-Academic Initi/ atives & Microsoft Innovation Center, Microsoft, and Prof. (Dr.) Deependra Kumar Jha, Vice- Chancellor, GD Goenka University. Mr. Venkatesh was immensely impressed by this event; the number of participations, the variety and quality of projects presented here, and the infrastructure and level of organization in this event.</p>
                  <span class="inline-block h-1 w-10 rounded bg-red-500 mt-6 mb-4"></span>
              </div>
            </div>
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div class="h-full text-center">
                <img alt="testimonial" class="w-full h-80 mb-8 object-cover object-center rounded-xl inline-block border-2 border-gray-200 bg-gray-100" src="/img/3.jpg"/>
                  <p class="leading-relaxed">After inauguration, the exhibition was open for general viewing and evaluation by judges. The project evaluation team consisted of Mr. Devendra/  Burman, Vice President, Accenture and Mr. Amit Sharma, Head, Phoenix (India) Pvt. Ltd. There was huge excitement among participants and the visitors.</p>
                  <span class="inline-block h-1 w-10 rounded bg-red-500 mt-6 mb-4"></span>
              </div>
            </div>
            <div class="lg:w-1/3 lg:mb-0 p-4">
              <div class="h-full text-center">
                <img alt="testimonial" class="w-full h-80 mb-8 object-cover object-center rounded-xl inline-block border-2 border-gray-200 bg-gray-100" src="/img/7a.png"/>
                  <p class="leading-relaxed">SPEED  will be organized at the sprawling campus of GD Goenka University which is located at the serene foothills of Aravali near Gurgaon at Gurgaon-Sohna Road. All science and engineering students from schools/universities/colleges are welcome to participate in this exciting competition and win exciting prizes apart from having fun!</p>
                  <span class="inline-block h-1 w-10 rounded bg-red-500 mt-6 mb-4"></span>
              </div>
            </div>
          </div>
